    ...
    public class CandidatoValidator : AbstractValidator<CandidatoViewModel>
    {
        public CandidatoValidator()
        {
            ...
            RuleFor(c => c.Nome)
                ...
                .Matches(@"^[a-zA-z\u00C0-\u00FF\s]{1,40}$").WithMessage("O nome não pode conter número e/ou caracteres especiais")
            ...
            RuleFor(c => c.Cidade)
                ...
                .Matches(@"^[a-zA-z\u00C0-\u00FF\s]{1,40}$").WithMessage("O nome da cidade não pode conter número e/ou caracteres especiais")
